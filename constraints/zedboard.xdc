...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {o_cam_pwdn}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {i_cam_data[0]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {i_cam_data[2]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {i_cam_data[4]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {o_cam_rstn}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {i_cam_data[1]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {i_cam_data[3]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {i_cam_data[5]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {i_cam_data[6]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {o_cam_xclk}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {i_cam_href}];  # "JB3"
set_property PACKAGE_PIN W8  [get_ports {io_cam_sda}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {i_cam_data[7]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {i_cam_pclk}];  # "JB8"
set_property PACKAGE_PIN V9  [get_ports {i_cam_vsync}];  # "JB9"
set_property PACKAGE_PIN V8  [get_ports {io_cam_scl}];  # "JB10"

set_property PULLUP true [get_ports {io_cam_sda}]
set_property PULLUP true [get_ports {io_cam_scl}]
# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
...
set_property PACKAGE_PIN U16  [get_ports {o_hdmi_de}];  # "HD-DE"
set_property PACKAGE_PIN V17  [get_ports {o_hdmi_hsync}];  # "HD-HSYNC"
set_property PACKAGE_PIN W16  [get_ports {i_hdmi_int}];  # "HD-INT"
set_property PACKAGE_PIN AA18 [get_ports {o_hdmi_iic_scl}];  # "HD-SCL"
set_property PACKAGE_PIN Y16  [get_ports {io_hdmi_iic_sda}];  # "HD-SDA"
set_property PACKAGE_PIN U15  [get_ports {o_hdmi_spdif}];  # "HD-SPDIF"
set_property PACKAGE_PIN Y18  [get_ports {i_hdmi_spdif_out}];  # "HD-SPDIFO"
set_property PACKAGE_PIN W17  [get_ports {o_hdmi_vsync}];  # "HD-VSYNC"

# ----------------------------------------------------------------------------
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {led_mode}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {led_gaussian}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {led_sobel}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {led_threshold}];  # "LD3"
...
#set_property PACKAGE_PIN N15 [get_ports {btn_decSobel}];  # "BTNL"
#set_property PACKAGE_PIN R18 [get_ports {btn_incSobel}];  # "BTNR"
#set_property PACKAGE_PIN T18 [get_ports {btn_mode}];  # "BTNU"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {sw_gaussian}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {sw_sobel}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {sw_freeze}];  # "SW2"
